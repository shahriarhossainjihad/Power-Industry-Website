...
<div class="row">
            ...
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                ...
                <hr>
                <form action="{{route('update.section',$section->id)}}" method="post" id ="myForm" enctype="multipart/form-data">
                    @csrf
                <!-- end row -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <select class="form-select " name="category_name"  aria-label="Default select example">
                            ...
                            <option value="{{$cat->id}}" {{$cat->id == $section->cat_id  ? 'selected' : '' }}>{{$cat->category_name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control" name="title" value="{{$section->title}}" type="text" placeholder="Enter Section Title" id="example-email-input">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                <textarea name="description" class="form-control"  id="summernote" >{!!$section->description!!}</textarea>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <img id="showImage" class="rounded avatar-lg " src="{{asset('uploads/section/'.$section->image)}}" alt="Section Image">
                    </div>
