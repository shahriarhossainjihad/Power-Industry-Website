               ...
               <ol class="breadcrumb m-0">
                ...
                <div class="col-sm-10 form-group">
                        ...
                        <select class="form-select @error('section') is-invalid  @enderror" name="section"  aria-label="Default select example">
                            ...
                            <option value="{{$sec->id}}"{{$sec->id == $sectionDetails->section_id  ? 'selected' : '' }}>{{$sec->title}}</option>
                            @endforeach
                        </select>
                        @error('section')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control @error('title') is-invalid  @enderror" value="{{$sectionDetails->title}}" name="title" type="text" placeholder="Enter Section Details Title" id="example-email-input">
                        @error('title')
                        <span class="text-danger">{{ $message }}</span>
                       @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                <textarea name="desciption" class="form-control @error('desciption') is-invalid  @enderror" id="summernote" >{!!$sectionDetails->desciption!!}</textarea>
                @error('desciption')
                        <span class="text-danger">{{ $message }}</span>
                       @enderror
            </div>
