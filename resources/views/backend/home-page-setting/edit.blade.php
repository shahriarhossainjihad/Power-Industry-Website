                    ...
                    <div class="card-body">
                        <form action="{{ route('update.home.settings', $homeData->id) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    {{-- <input type="text" class="form-control tag @error('keywords') is-invalid  @enderror"
                                        ...
                                        <input name="keywords" value="{{$homeData->keywords }}" class="form-control @error('keywords') is-invalid  @enderror" type="text" data-role="tagsinput">
                                    @error('keywords')
                                ...
                                <div class="col-sm-10">
                                    <div class="my_tags_input">
                                        ...
                                        <input type="text" id="input-tag"
                                            ...
                                            name="keywords" value="{{ $homeData->keywords }}" />
                                        @error('keywords')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="file" value="{{ $homeData->logo }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg "
                                        src="{{ asset('uploads/home-settings/' . $homeData->logo) }}" alt="image">
                                    @error('logo')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="file" value="{{ $homeData->fav }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage2" class="rounded avatar-lg"
                                        src="{{ asset('uploads/home-settings/' . $homeData->fav) }}" alt="image">
                                    @error('fav')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
